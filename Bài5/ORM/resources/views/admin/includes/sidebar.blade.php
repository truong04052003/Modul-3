    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('categories.index')}}">
          <i class="bi bi-menu-button-wide"></i><span>Categories</span><i ></i>
        </a>

      <li class="nav-item">
        <a class="nav-link collapsed"  href="{{route('products.index')}}">
          <i class="bi bi-journal-text"></i><span>Products</span><i></i>
        </a>
        

      <li class="nav-item">
        <a class="nav-link collapsed"  href="{{route('orders.index')}}">
          <i class="bi bi-layout-text-window-reverse"></i><span>Orders</span><i></i>
        </a>

      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('product_codes.index')}}">
          <i class="bi bi-bar-chart"></i><span>ProductCode</span><i></i>
        </a>
      <li class="nav-item">
