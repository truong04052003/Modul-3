  ...
  <body>
    ...
    <form action="{{route('products.store')}}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="created_at" class="form-control" id="exampleInputPassword1">
          </div>
          <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">updated_at</label>
            <input type="text" name="updated_at" class="form-control" id="exampleInputPassword1">
          </div>
